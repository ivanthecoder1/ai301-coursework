...
My main technology stack is JavaScript / TypeScript, React, Python, and Java. 
I would avoid any work relating to the use of C and C++. As I find the language too verbose.
I also want to avoid any mobile work (Kotlin, Swift, etc). 
Other than that, I am open to any technology and I am looking to get better with cloud. 